                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="{{url('admin/insert_update_category/'.$data->slug)}}" method="post" >
                                        @csrf 
                                        <div class="form-group">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="text" name="slug" type="text" class="form-control cc-name valid"  value="{{$data->slug}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="description" name="description"  class="form-control cc-number identified visa" >
                                                {{$data->name}}
                                                </textarea>
                                                @error('description')
                                                <div class="alert alert-danger">
